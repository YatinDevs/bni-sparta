      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col">
          <div className="order-2 lg:order-1 flex ">
            <div className="text-white p-8 rounded-lg  bg-[#CF2030] flex gap-10">
              <div>
                ...
                <address className="text-lg text-white mb-8 not-italic">
                  Wrexham Road, Pulford,
                  <br />
                  Chester CH4 9DG
                </address>
                <div>
                  <button className="cursor-pointer bg-[#B01A28] hover:bg-[#241416] text-white font-semibold py-3 px-8 rounded-2xl transition duration-300 text-lg">
                    Watch Inside
                  </button>
                </div>
              </div>
              <div className="mb-8">
                <div className="aspect-square overflow-hidden rounded-lg ">
                  <img
                    ...
                    alt={`Venue image`}
                    className="w-64 h-64 object-cover hover:scale-105 transition duration-300"
                    loading="lazy"
                  />
                </div>
              </div>
